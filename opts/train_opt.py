from opts.basic import BaseOptions
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--continue_train', default=False,
        ...
        self.parser.add_argument(
            '--config', type=str, default='configs/unit_gta2city_folder.yaml', help='Path to the config file.')
        self.isTrain = True
